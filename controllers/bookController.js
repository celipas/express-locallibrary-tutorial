...
exports.book_create_get = (req, res, next) => {
  // Get all authors and genres, which e an use for adding to our book.
  async.parallel(
    {
...
exports.book_update_post = [
  // Convert the genre to an array
  (req, res, next) => {
    // do we need to update this to params?
    if (!(req.body.genre instanceof Array)) {
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      Book.findByIdAndUpdate(req.params.id, book, {}, (err, thebook) => {
        ...
        // Sucessful - redirect to the book detail page.
